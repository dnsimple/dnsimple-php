...
- Added `Domains.domainResearchStatus` to research a domain name for availability and registration status information. This endpoint is part of a Private Beta.
